...
img = sitk.ReadImage(r'C:\Users\lpc\Desktop\data\volume-1002897749.nii.gz')
img = sitk.GetArrayFromImage(img)
lbl = sitk.ReadImage(r'C:\Users\lpc\Desktop\data\segmentation-1002897749.nii.gz')
...
for i in range(10):
    ...
    sitk.WriteImage(img, r'C:\Users\lpc\Desktop\data\\' + str(i) + '.nii.gz')
    sitk.WriteImage(lbl, r'C:\Users\lpc\Desktop\data\\' + str(i) + '_seg.nii.gz')
    # view_batch(img, lbl)